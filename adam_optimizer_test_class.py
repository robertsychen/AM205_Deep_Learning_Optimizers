#Adam optimizer copied from https://github.com/tensorflow/tensorflow/blob/master/tensorflow/python/training/adam.py
#We change the name to AdamOptimizerTest to confirm that everything would work as desired for the custom
#optimizer functions that we write, as long as we follow the Adam code as a template.
...
class AdamOptimizerTest(optimizer.Optimizer):
  ...
  def __init__(self, learning_rate=0.001, beta1=0.9, beta2=0.999, epsilon=1e-8,
    ...
    Args:
      ...
      name: Optional name for the operations created when applying gradients.
        Defaults to "Adam".
    """
    super(AdamOptimizerTest, self).__init__(use_locking, name)
